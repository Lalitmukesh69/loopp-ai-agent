...
export default function RoleCoverageSection() {
  ...
  const rolesData = [
    {
      badgeText: "Product Managers",
      badgeBg: "bg-[#E6E1F0]",
      badgeTextColor: "text-[#46395A]",
      items: [
        "Turn raw user feedback into actionable PRDs instantly",
        "Keep stakeholders aligned with shared summaries and action items"
      ]
    },
    {
      badgeText: "UX Researchers",
      badgeBg: "bg-[#F4D7D1]",
      badgeTextColor: "text-[#552D26]",
      items: [
        "Focus on empathy and observation without losing session details",
        "Automatically synthesize patterns across multiple interviews"
      ]
    },
    {
      badgeText: "Product Designers",
      badgeBg: "bg-[#E1EAF4]",
      badgeTextColor: "text-[#2F435C]",
      items: [
        "Capture specific usability friction points correctly",
        "Reference user quotes directly for evidence-based design"
      ]
    }
  ];
